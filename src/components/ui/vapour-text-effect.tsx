...
type VaporizeTextCycleProps = {
  ...
  tag?: Tag;
  loop?: boolean; // If false, animation plays once and text stays gone
};
...
export default function VaporizeTextCycle({
  ...
  const [animationState, setAnimationState] = useState<"static" | "vaporizing" | "fadingIn" | "waiting" | "done">("static");
  ...
  useEffect(() => {
    ...
    const animate = (currentTime: number) => {
      ...
      switch (animationState) {
        ...
        case "vaporizing": {
          ...
          if (vaporizeProgressRef.current >= 100 && allVaporized) {
            if (loop) {
              ...
              // If not looping, stay done (text stays gone)
        ...
        case "done": {
          // Text has vaporized and stays gone - don't render anything
          break;
        }
      }
